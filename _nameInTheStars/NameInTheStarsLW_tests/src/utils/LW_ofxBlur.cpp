...
LW_ofxBlur::LW_ofxBlur()
:scale(1)
,rotation(0)
,brightness(1) {
}

void LW_ofxBlur::setup(int width, int height, int radius, float shape, int passes, float downsample) {
...
void LW_ofxBlur::setScale(float scale) {
	this->scale = scale;
}

void LW_ofxBlur::setRotation(float rotation) {
	this->rotation = rotation;
}

void LW_ofxBlur::setBrightness(float brightness) {
	this->brightness = brightness;
}

void LW_ofxBlur::begin() {
	base.begin();
}
...
ofTexture& LW_ofxBlur::getTexture() {
	return base.getTexture();
}

void LW_ofxBlur::draw() {
	base.draw(0, 0);
}

void LW_ofxBlur::draw(ofRectangle rect) {
    base.draw(rect);
}
